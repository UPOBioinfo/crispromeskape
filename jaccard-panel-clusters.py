...
unique_combis = ["No_clust", "c1_ifa", "c1_ifb", "c2_ifa", "c2_ifb"]
...
for idx, s in enumerate(species):
    ...
    for mlst in clust_map.index:
        if clust_map[mlst] == "No_clust":
            pass
        elif "'I-" in clust_map[mlst] and "'II-" in clust_map[mlst]:
            clust_map[mlst] = "I + II"
        elif "'I-" in clust_map[mlst] and "'III-" in clust_map[mlst]:
            clust_map[mlst] = "I + III"
        elif "'II-" in clust_map[mlst] and "'III-" in clust_map[mlst]:
            clust_map[mlst] = "II + III"
        elif "'I-" in clust_map[mlst] and "'IV-" in clust_map[mlst]:
            clust_map[mlst] = "I + IV"
        elif "'IV-" in clust_map[mlst]:
            clust_map[mlst] = "IV"
        elif "'III-" in clust_map[mlst]:
            clust_map[mlst] = "III"
        elif "'II-" in clust_map[mlst]:
            clust_map[mlst] = "II"
        elif "'I-" in clust_map[mlst]:
            clust_map[mlst] = "I"
        else:
